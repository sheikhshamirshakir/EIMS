...
import views.html.bookcategory.*;

public class BookCategoryManagement extends Controller{
...
//	@Dynamic(value = "Entry Employee Category", handler = DeadboltHandler.class)
	 public static Result save() {
	     ...
	     //return ok("");
	   	return redirect(controllers.routes.BookCategoryManagement.list());
	    }
	 }
	 ...
	 public static Result edit(Long id) {
		 Category category = Category.findById(id);
		  	...
		  	if (category == null) {
				flash("error", AppConstants.ERROR_MESSAGE_ID_NOT_FOUND);
				//return ok("");
				return redirect(controllers.routes.BookCategoryManagement.show(id));
			}else
